...
3. **Design Pattern Advisor** — recommends patterns that improve extensibility, testability, or clarity.
...
3. **Analyse structure**: Map dependencies, identify coupling issues, complexity hotspots, and design smells.
4. **Plan steps**: Break the refactoring into small, independent transformations. Each step must leave tests green.
...
Apply skill: `refactor` throughout for guidance on safe transformation techniques.
