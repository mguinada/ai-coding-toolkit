...
For detailed mocking patterns and framework-specific examples, user skill: `tdd`.
...
*Adapted from [Everything Claude Code](https://github.com/affaan-m/everything-claude-code) (credit: [Affaan Mustafa](https://github.com/affaan-m)) under MIT license.*
